 ...
 */n=function(e,t){if(!(this instanceof n))return new n(e,t);var r;var a=[];var i=function(e){var t=Nt(e);t&&a.push.apply(a,t)};if(Array.isArray(e))for(r=0;r<e.length;r++)i(e[r]);else i(e);this.context=a.length>1?L(a):a;_t(this,t);this.selector={rows:null,cols:null,opts:null};n.extend(this,this,Lt)};r.Api=n;t.extend(n.prototype,{any:function(){return this.count()!==0},context:[],count:function(){return this.flatten().length},each:function(e){for(var t=0,r=this.length;t<r;t++)e.call(this,this[t],t,this);return this},eq:function(e){var t=this.context;return t.length>e?new n(t[e],this[e]):null},filter:function(e){var t=At.filter.call(this,e,this);return new n(this.context,t)},flatten:function(){var e=[];return new n(this.context,e.concat.apply(e,this.toArray()))},get:function(e){return this[e]},join:At.join,includes:function(e){return this.indexOf(e)!==-1},indexOf:At.indexOf,iterator:function(e,t,r,a){var i,o,l,s,u,c,f,d,v=[],h=this.context,p=this.selector;if(typeof e==="string"){a=r;r=t;t=e;e=false}for(o=0,l=h.length;o<l;o++){var g=new n(h[o]);if(t==="table"){i=r.call(g,h[o],o);i!==void 0&&v.push(i)}else if(t==="columns"||t==="rows"){i=r.call(g,h[o],this[o],o);i!==void 0&&v.push(i)}else if(t==="every"||t==="column"||t==="column-rows"||t==="row"||t==="cell"){f=this[o];t==="column-rows"&&(c=Mt(h[o],p.opts));for(s=0,u=f.length;s<u;s++){d=f[s];i=t==="cell"?r.call(g,h[o],d.row,d.column,o,s):r.call(g,h[o],d,o,s,c);i!==void 0&&v.push(i)}}}if(v.length||a){var m=new n(h,e?v.concat.apply([],v):v);var b=m.selector;b.rows=p.rows;b.cols=p.cols;b.opts=p.opts;return m}return this},lastIndexOf:At.lastIndexOf,length:0,map:function(e){var t=At.map.call(this,e,this);return new n(this.context,t)},pluck:function(e){var t=r.util.get(e);return this.map((function(e){return t(e)}))},pop:At.pop,push:At.push,reduce:At.reduce,reduceRight:At.reduceRight,reverse:At.reverse,selector:null,shift:At.shift,slice:function(){return new n(this.context,this)},sort:At.sort,splice:At.splice,toArray:function(){return At.slice.call(this)},to$:function(){return t(this)},toJQuery:function(){return t(this)},unique:function(){return new n(this.context,L(this.toArray()))},unshift:At.unshift});function Ft(e,t,r){return function(){var a=t.apply(e||this,arguments);n.extend(a,a,r.methodExt);return a}}function Ot(e,t){for(var r=0,a=e.length;r<a;r++)if(e[r].name===t)return e[r];return null}window.__apiStruct=Lt;n.extend=function(e,t,r){if(r.length&&t&&(t instanceof n||t.__dt_wrapper)){var a,i,o;for(a=0,i=r.length;a<i;a++){o=r[a];if(o.name!=="__proto__"){t[o.name]=o.type==="function"?Ft(e,o.val,o):o.type==="object"?{}:o.val;t[o.name].__dt_wrapper=true;n.extend(e,t[o.name],o.propExt)}}}};n.register=i=function(e,r){if(Array.isArray(e))for(var a=0,i=e.length;a<i;a++)n.register(e[a],r);else{var o,l,s,u,c=e.split("."),f=Lt;for(o=0,l=c.length;o<l;o++){u=c[o].indexOf("()")!==-1;s=u?c[o].replace("()",""):c[o];var d=Ot(f,s);if(!d){d={name:s,val:{},methodExt:[],propExt:[],type:"object"};f.push(d)}if(o===l-1){d.val=r;d.type=typeof r==="function"?"function":t.isPlainObject(r)?"object":"other"}else f=u?d.methodExt:d.propExt}}};n.registerPlural=o=function(e,t,r){n.register(e,r);n.register(t,(function(){var e=r.apply(this,arguments);return e===this?this:e instanceof n?e.length?Array.isArray(e[0])?new n(e.context,e[0]):e[0]:void 0:e}))};
/**
 ...
 * @returns {DataTables.Api} this
 */i("page.len()",(function(e){return e===void 0?this.context.length!==0?this.context[0]._iDisplayLength:void 0:this.iterator("table",(function(t){Ue(t,e)}))}));var jt=function(e,t,r){if(r){var a=new n(e);a.one("draw",(function(){r(a.ajax.json())}))}if(St(e)=="ssp")ye(e,t);else{Ye(e,true);var i=e.jqXHR;i&&i.readyState!==4&&i.abort();Ae(e,{},(function(r){ue(e);var a=Re(e,r);for(var n=0,i=a.length;n<i;n++)K(e,a[n]);ye(e,t);qe(e);Ye(e,false)}))}};i("ajax.json()",(function(){var e=this.context;if(e.length>0)return e[0].json}));i("ajax.params()",(function(){var e=this.context;if(e.length>0)return e[0].oAjaxData}));
/**
