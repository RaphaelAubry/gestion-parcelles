...
/**
	 ...
	 *  @private
	 */
_columnsVisibility:function(e){var t=this.s.dt;var n=this.s.columns;var i,s;var a=n.map((function(e,t){return{columnIdx:t,priority:e.priority}})).sort((function(e,t){return e.priority!==t.priority?e.priority-t.priority:e.columnIdx-t.columnIdx}));var o=r.map(n,(function(n,i){return t.column(i).visible()===false?"not-visible":(!n.auto||n.minWidth!==null)&&(n.auto===true?"-":r.inArray(e,n.includeIn)!==-1)}));var d=0;for(i=0,s=o.length;i<s;i++)o[i]===true&&(d+=n[i].minWidth);var l=t.settings()[0].oScroll;var c=l.sY||l.sX?l.iBarWidth:0;var u=t.table().container().offsetWidth-c;var f=u-d;for(i=0,s=o.length;i<s;i++)n[i].control&&(f-=n[i].minWidth);var h=false;for(i=0,s=a.length;i<s;i++){var v=a[i].columnIdx;if(o[v]==="-"&&!n[v].control&&n[v].minWidth){if(h||f-n[v].minWidth<0){h=true;o[v]=false}else o[v]=true;f-=n[v].minWidth}}var p=false;for(i=0,s=n.length;i<s;i++)if(!n[i].control&&!n[i].never&&o[i]===false){p=true;break}for(i=0,s=n.length;i<s;i++){n[i].control&&(o[i]=p);o[i]==="not-visible"&&(o[i]=false)}r.inArray(true,o)===-1&&(o[0]=true);return o},_classLogic:function(){var e=this;var t=this.c.breakpoints;var n=this.s.dt;var i=n.columns().eq(0).map((function(e){var t=this.column(e);var r=t.header().className;var n=t.init().responsivePriority;var i=t.header().getAttribute("data-priority");n===void 0&&(n=i===void 0||i===null?1e4:i*1);return{className:r,includeIn:[],auto:false,control:false,never:!!r.match(/\b(dtr\-)?never\b/),priority:n}}));var s=function(e,t){var n=i[e].includeIn;r.inArray(t,n)===-1&&n.push(t)};var a=function(r,n,a,o){var d,l,c;if(a){if(a==="max-"){d=e._find(n).width;for(l=0,c=t.length;l<c;l++)t[l].width<=d&&s(r,t[l].name)}else if(a==="min-"){d=e._find(n).width;for(l=0,c=t.length;l<c;l++)t[l].width>=d&&s(r,t[l].name)}else if(a==="not-")for(l=0,c=t.length;l<c;l++)t[l].name.indexOf(o)===-1&&s(r,t[l].name)}else i[r].includeIn.push(n)};i.each((function(e,n){var i=e.className.split(" ");var s=false;for(var o=0,d=i.length;o<d;o++){var l=i[o].trim();if(l==="all"||l==="dtr-all"){s=true;e.includeIn=r.map(t,(function(e){return e.name}));return}if(l==="none"||l==="dtr-none"||e.never){s=true;return}if(l==="control"||l==="dtr-control"){s=true;e.control=true;return}r.each(t,(function(e,t){var r=t.name.split("-");var i=new RegExp("(min\\-|max\\-|not\\-)?("+r[0]+")(\\-[_a-zA-Z0-9])?");var o=l.match(i);if(o){s=true;o[2]===r[0]&&o[3]==="-"+r[1]?a(n,t.name,o[1],o[2]+o[3]):o[2]!==r[0]||o[3]||a(n,t.name,o[1],o[2])}}))}s||(e.auto=true)}));this.s.columns=i},_controlClass:function(){if(this.c.details.type==="inline"){var e=this.s.dt;var t=this.s.current;var n=r.inArray(true,t);e.cells(null,(function(e){return e!==n}),{page:"current"}).nodes().to$().filter(".dtr-control").removeClass("dtr-control");n>=0&&e.cells(null,n,{page:"current"}).nodes().to$().addClass("dtr-control")}this._tabIndexes()},
/**
	 ...
	 * @private
	 */
_detailsDisplay:function(e,t){var i=this;var s=this.s.dt;var a=this.c.details;var o=function(n){r(e.node()).toggleClass("dtr-expanded",n!==false);r(s.table().node()).triggerHandler("responsive-display.dt",[s,e,n,t])};if(a&&a.type!==false){var d=typeof a.renderer==="string"?n.renderer[a.renderer]():a.renderer;var l=a.display(e,t,(function(){return d.call(i,s,e[0][0],i._detailsObj(e[0]))}),(function(){o(false)}));typeof l==="boolean"&&o(l)}},_detailsInit:function(){var e=this;var t=this.s.dt;var n=this.c.details;n.type==="inline"&&(n.target="td.dtr-control, th.dtr-control");r(t.table().body()).on("keyup.dtr","td, th",(function(e){e.keyCode===13&&r(this).data("dtr-keyboard")&&r(this).click()}));var i=n.target;var s=typeof i==="string"?i:"td, th";i===void 0&&i===null||r(t.table().body()).on("click.dtr mousedown.dtr mouseup.dtr",s,(function(n){if(r(t.table().node()).hasClass("collapsed")&&r.inArray(r(this).closest("tr").get(0),t.rows().nodes().toArray())!==-1){if(typeof i==="number"){var s=i<0?t.columns().eq(0).length+i:i;if(t.cell(this).index().column!==s)return}var a=t.row(r(this).closest("tr"));n.type==="click"?e._detailsDisplay(a,false):n.type==="mousedown"?r(this).css("outline","none"):n.type==="mouseup"&&r(this).trigger("blur").css("outline","")}}))},
/**
	 * Get the details to pass to a renderer for a row
	 * @param  {int} rowIdx Row index
	 * @private
	 */
_detailsObj:function(e){var t=this;var n=this.s.dt;var i=[];let s=n.settings()[0];return r.map(this.s.columns,(function(r,a){if(!r.never&&!r.control){var o=s.aoColumns[a];i[a]||(i[a]=n.column(a));return{className:o.sClass,columnIndex:a,data:s.fastData(e,a,t.c.orthogonal),hidden:i[a].visible()&&!t.s.current[a],rowIndex:e,title:i[a].title()}}}))},
/**
...
/**
	 ...
	 */
_colspan:function(e,t){var r=1;for(var n=t+1;n<e.length;n++)if(e[n]===null&&this.s.current[n])r++;else if(e[n])break;return r},_tabIndexes:function(){var e=this.s.dt;var t=e.cells({page:"current"}).nodes().to$();var n=e.settings()[0];var i=this.c.details.target;t.filter("[data-dtr-keyboard]").removeData("[data-dtr-keyboard]");if(typeof i==="number")e.cells(null,i,{page:"current"}).nodes().to$().attr("tabIndex",n.iTabIndex).data("dtr-keyboard",1);else{i==="td:first-child, th:first-child"&&(i=">td:first-child, >th:first-child");var s=e.rows({page:"current"}).nodes();var a=i==="tr"?r(s):r(i,s);a.attr("tabIndex",n.iTabIndex).data("dtr-keyboard",1)}}});n.breakpoints=[{name:"desktop",width:Infinity},{name:"tablet-l",width:1024},{name:"tablet-p",width:768},{name:"mobile-l",width:480},{name:"mobile-p",width:320}];n.display={childRow:function(e,t,n){var i=r(e.node());if(!t){if(i.hasClass("dtr-expanded")){e.child(false);return false}var s=n();if(s===false)return false;e.child(s,"child").show();return true}if(i.hasClass("dtr-expanded")){e.child(n(),"child").show();return true}},childRowImmediate:function(e,t,n){var i=r(e.node());if(!t&&i.hasClass("dtr-expanded")||!e.responsive.hasHidden()){e.child(false);return false}var s=n();if(s===false)return false;e.child(s,"child").show();return true},modal:function(e){return function(t,n,i,s){var a;var o=i();if(o===false)return false;if(n){a=r("div.dtr-modal-content");if(!a.length||t.index()!==a.data("dtr-row-idx"))return null;a.empty().append(o)}else{var d=function(){a.remove();r(document).off("keypress.dtr");r(t.node()).removeClass("dtr-expanded");s()};a=r('<div class="dtr-modal"/>').append(r('<div class="dtr-modal-display"/>').append(r('<div class="dtr-modal-content"/>').data("dtr-row-idx",t.index()).append(o)).append(r('<div class="dtr-modal-close">&times;</div>').click((function(){d()})))).append(r('<div class="dtr-modal-background"/>').click((function(){d()}))).appendTo("body");r(t.node()).addClass("dtr-expanded");r(document).on("keyup.dtr",(function(e){if(e.keyCode===27){e.stopPropagation();d()}}))}e&&e.header&&r("div.dtr-modal-content").prepend("<h2>"+e.header(t)+"</h2>");return true}}};n.renderer={listHiddenNodes:function(){var e=function(e,t,n){var i=this;var s=r('<ul data-dtr-index="'+t+'" class="dtr-details"/>');var a=false;r.each(n,(function(t,n){if(n.hidden){var o=n.className?'class="'+n.className+'"':"";r("<li "+o+' data-dtr-index="'+n.columnIndex+'" data-dt-row="'+n.rowIndex+'" data-dt-column="'+n.columnIndex+'"><span class="dtr-title">'+n.title+"</span> </li>").append(r('<span class="dtr-data"/>').append(i._childNodes(e,n.rowIndex,n.columnIndex))).appendTo(s);a=true}}));return!!a&&s};e._responsiveMovesNodes=true;return e},listHidden:function(){return function(e,t,n){var i=r.map(n,(function(e){var t=e.className?'class="'+e.className+'"':"";return e.hidden?"<li "+t+' data-dtr-index="'+e.columnIndex+'" data-dt-row="'+e.rowIndex+'" data-dt-column="'+e.columnIndex+'"><span class="dtr-title">'+e.title+'</span> <span class="dtr-data">'+e.data+"</span></li>":""})).join("");return!!i&&r('<ul data-dtr-index="'+t+'" class="dtr-details"/>').append(i)}},tableAll:function(e){e=r.extend({tableClass:""},e);return function(t,n,i){var s=r.map(i,(function(e){var t=e.className?'class="'+e.className+'"':"";return"<tr "+t+' data-dt-row="'+e.rowIndex+'" data-dt-column="'+e.columnIndex+'"><td>'+(""!==e.title?e.title+":":"")+"</td> <td>"+e.data+"</td></tr>"})).join("");return r('<table class="'+e.tableClass+' dtr-details" width="100%"/>').append(s)}}};n.defaults={
/**
...
/**
	 ...
	 * @type {Object|string}
	 */
details:{display:n.display.childRow,renderer:n.renderer.listHidden(),target:0,type:"inline"},
/**
	 ...
	 * @type {String}
	 */
orthogonal:"display"};var i=r.fn.dataTable.Api;i.register("responsive()",(function(){return this}));i.register("responsive.index()",(function(e){e=r(e);return{column:e.data("dtr-index"),row:e.parent().data("dtr-index")}}));i.register("responsive.rebuild()",(function(){return this.iterator("table",(function(e){e._responsive&&e._responsive._classLogic()}))}));i.register("responsive.recalc()",(function(){return this.iterator("table",(function(e){if(e._responsive){e._responsive._resizeAuto();e._responsive._resize()}}))}));i.register("responsive.hasHidden()",(function(){var e=this.context[0];return!!e._responsive&&r.inArray(false,e._responsive._responsiveOnlyHidden())!==-1}));i.registerPlural("columns().responsiveHidden()","column().responsiveHidden()",(function(){return this.iterator("column",(function(e,t){return!!e._responsive&&e._responsive._responsiveOnlyHidden()[t]}),1)}));n.version="3.0.5";r.fn.dataTable.Responsive=n;r.fn.DataTable.Responsive=n;r(document).on("preInit.dt.dtr",(function(e,i,s){if(e.namespace==="dt"&&(r(i.nTable).hasClass("responsive")||r(i.nTable).hasClass("dt-responsive")||i.oInit.responsive||t.defaults.responsive)){var a=i.oInit.responsive;a!==false&&new n(i,r.isPlainObject(a)?a:{})}}));
