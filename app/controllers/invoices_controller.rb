        ...
        render json: {
          ...
          data: @invoices.map do |i|
                  [ i.invoicer,
                    ...
                    i.number,
                    i.contract_name,
                    "<a href='/invoices/#{i.id}/edit'>modifier</a>
                     <a href='/invoices/#{i.id}' data-turbo-method='delete'>supprimer</a>
                    "
                  ]
                end
          }
  ...
  def new
    if params[:contract_id]
      ...
      if @contract.parcelles.empty?
        redirect_to invoices_path, notice: "Vous devez rattacher des parcelles à ce contrat #{@contract.name}"
      end
